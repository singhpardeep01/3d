...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    x = 0
    while( x < len(m) ):
        add_edge( points, m[x][0], m[x][1], m[x][2], m[x][0], m[x][1], m[x][2] )
        x += 1        
    pass
def generate_sphere( points, cx, cy, cz, r, step ):
    ...
    while( rot <= t ):
        circ = 0
        while( circ <= t ):
            x = r * math.cos(math.pi * circ * step) + cx
            y = r * math.sin(math.pi * circ * step) * math.cos(2 * math.pi * rot * step) + cy
            z = r * math.sin(math.pi * circ * step) * math.sin(2 * math.pi * rot * step) + cz
            m.append([x, y, z])
            circ += 1
        rot += 1
    return m
...
def generate_torus( points, cx, cy, cz, r0, r1, step ):
    ...
    while( rot <= t ):
        circ = 0
        while( circ <= t ):
            x = math.cos(2 * math.pi * rot * step) * (r0 * math.cos(2 * math.pi * circ * step) + r1) + cx
            y = r0 * math.sin(2 * math.pi * circ * step) + r1 + cy
            z = math.sin(2 * math.pi * rot * step) * (r0 * math.cos(2 * math.pi * circ * step) + r1) + cz
            m.append([x, y, z])
            circ += 1
        rot += 1
    return m
